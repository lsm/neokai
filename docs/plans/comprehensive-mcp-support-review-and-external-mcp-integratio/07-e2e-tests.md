...
**Depends on:** Task 5.2 (AppMcpServersSettings UI), Task 5.3 (Per-Room MCP UI), Task 4.2 (Room/Session integration), Task 3.2 (RoomRuntimeService integration), Task 6.2 (Default MCP Seeds)
