...
describe("MessageHub Protocol", () => {
  ...
  describe("Message Validators", () => {
    ...
    test("isCallMessage should identify CALL messages", () => {
      ...
      const resultMsg = createResultMessage({ method: "test", data: {}, sessionId: "s1", requestId: "req1", id: "msg2" });
    ...
    test("isResultMessage should identify RESULT messages", () => {
      const resultMsg = createResultMessage({ method: "test", data: {}, sessionId: "s1", requestId: "req1", id: "msg1" });
    ...
    test("isErrorMessage should identify ERROR messages", () => {
      const errorMsg = createErrorMessage({ method: "test", error: "fail", sessionId: "s1", requestId: "req1", id: "msg1" });
      const callMsg = createCallMessage({ method: "test", data: {}, sessionId: "s1", id: "msg2" });
    ...
    test("isResponseMessage should identify RESULT and ERROR messages", () => {
      const resultMsg = createResultMessage({ method: "test", data: {}, sessionId: "s1", requestId: "req1", id: "msg1" });
      const errorMsg = createErrorMessage({ method: "test", error: "fail", sessionId: "s1", requestId: "req1", id: "msg2" });
  ...
  describe("Message IDs", () => {
    test("should use provided message ID", () => {
      const msg1 = createCallMessage({ method: "test", data: {}, sessionId: "s1", id: "custom-id-1" });
      const msg2 = createCallMessage({ method: "test", data: {}, sessionId: "s1", id: "custom-id-2" });
