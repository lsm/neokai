...
export class GlobalStore {
  ...
  readonly authStatus = computed<AuthStatus | null>(
    () => this.systemState.value?.auth || null,
  );
  ...
  readonly apiConnectionStatus = computed<
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      if (snapshot) {
        ...
        this.hasArchivedSessions.value =
          snapshot.sessions?.hasArchivedSessions || false;
