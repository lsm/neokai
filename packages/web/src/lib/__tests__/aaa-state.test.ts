...
describe("ApplicationState", () => {
  ...
  beforeEach(() => {
    ...
    currentSessionId = signal(null) as import("@preact/signals").Signal<
      string | null
    >;
  });
  ...
  describe("Subscription Leak Prevention", () => {
    it("should track subscriptions for cleanup", async () => {
      ...
      const subscriptions = (
        appState as unknown as { subscriptions: Array<() => void> }
      ).subscriptions;
  ...
  describe("Session Channel Management", () => {
    it("should auto-load session channels when currentSessionId changes", async () => {
      ...
      const activeSessionIdBefore = (
        appState as unknown as { activeSessionId: string | null }
      ).activeSessionId;
  ...
  describe("Initialization State", () => {
    ...
    it("should reset initialized flag on cleanup", async () => {
      ...
      const initialized = (
        appState as unknown as { initialized: { value: boolean } }
      ).initialized;
...
describe("ApplicationState - Edge Cases", () => {
  ...
  it("should throw when getSessionChannels called before init", () => {
    ...
    expect(() => appState.getSessionChannels("test")).toThrow(
