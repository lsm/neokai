...
describe("StateChannel", () => {
  ...
  describe("constructor", () => {
    it("should create with default options", () => {
      channel = new StateChannel(
        mockHub as unknown as MessageHub,
        "test.channel",
      );
  ...
  describe("start", () => {
    ...
    it("should throw on fetch error", async () => {
      mockHub.call.mockImplementation(() =>
  ...
  describe("refresh", () => {
    it("should fetch new snapshot", async () => {
      ...
      mockHub.call.mockImplementation(() =>
        Promise.resolve({ data: "refreshed" }),
      );
  ...
  describe("updateOptimistic", () => {
    ...
    it("should warn when state is null", () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        "Cannot update optimistically: state is null",
      );
      warnSpy.mockRestore();
    });
  });
