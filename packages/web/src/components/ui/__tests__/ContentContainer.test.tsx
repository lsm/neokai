...
describe("ContentContainer", () => {
  describe("Rendering", () => {
    ...
    it("should render text children", () => {
      const { container } = render(
        <ContentContainer>Plain text content</ContentContainer>,
      );
  ...
  describe("Class Combination", () => {
    it("should place base classes before custom classes", () => {
      ...
      expect(classes?.indexOf("mx-auto")).toBeLessThan(
        classes?.indexOf("custom") || 999,
      );
      expect(classes?.indexOf("px-4")).toBeLessThan(
        classes?.indexOf("custom") || 999,
      );
      expect(classes?.indexOf("w-full")).toBeLessThan(
        classes?.indexOf("custom") || 999,
      );
    });
