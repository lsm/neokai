...
function ThinkingBorderRing({ level }: { level: ThinkingLevel }) {
  ...
  const dashPercent =
    level === "think8k" ? 0.25 : level === "think16k" ? 0.5 : 1;
  ...
  const strokeColor =
    level === "think8k"
      ...
      : level === "think16k"
        ? "#f59e0b"
        : "#fbbf24"; // amber-600, amber-500, amber-400
...
export default function SessionStatusBar({
  ...
  const currentModelIcon = currentModelInfo
      ...
      <div class="flex items-center gap-3 sm:gap-4">
        ...
        <div class="relative">
          <button
            ...
            title={
              currentModelInfo
                ? `Switch Model (${currentModelInfo.name})`
                : "Switch Model"
            }
          >
        ...
        <div class="relative">
          ...
          {thinkingDropdown.isOpen && (
            ...
            >
              ...
              {(["auto", "think8k", "think16k", "think32k"] as const).map(
                (level) => (
                  <button
                    key={level}
                    class={`w-full text-left px-3 py-2 hover:bg-dark-700 text-xs flex items-center gap-2 ${
