...
export function QuestionPrompt({
      ...
      return (
        <svg
          class={cn(
            ...
            questionColors.submitted.iconColor,
          )}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
    ...
    if (resolvedState === "cancelled") {
      return (
        <svg
          class={cn(
            "w-4 h-4 flex-shrink-0",
            questionColors.cancelled.iconColor,
          )}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
  ...
  const getChevronColor = () => {
    if (resolvedState === "submitted")
      return questionColors.submitted.iconColor;
    if (resolvedState === "cancelled")
      return questionColors.cancelled.iconColor;
        ...
        <div class="p-4 border-t bg-white dark:bg-gray-900 space-y-4 border-rose-200 dark:border-rose-800">
          {questions.map((question, qIndex) => (
            <div
              ...
              class={cn(
                "space-y-3",
                qIndex > 0 && "pt-4 border-t border-dark-700",
              )}
            >
                ...
                <span
                  class={cn(
                    ...
                    resolvedState === "cancelled"
                      ...
                      : cn(
                          "bg-rose-900/50 text-rose-300 border",
                          questionColors.active.border,
                        ),
                  )}
                >
