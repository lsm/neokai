...
export function SectionSwitcher({ onClose }: SectionSwitcherProps) {
	...
	return (
		<div class={`flex items-center gap-2 px-2 py-2 border-b ${borderColors.ui.default}`}>
			<div class="grid grid-cols-2 flex-1 rounded-lg bg-dark-900/60 p-0.5" role="tablist">
			...
			{onClose && (
				<button
					type="button"
					onClick={onClose}
					class="md:hidden flex p-1.5 rounded-lg text-gray-400 hover:text-gray-100 hover:bg-white/5 transition-colors"
					title="Close panel"
