...
describe("MarkdownRenderer", () => {
  describe("Basic Rendering", () => {
    ...
    it("should merge custom className", () => {
      const { container } = render(
        <MarkdownRenderer content="Test" class="custom-class" />,
      );
    ...
    it("should handle empty className", () => {
      const { container } = render(
        <MarkdownRenderer content="Test" class="" />,
      );
      const div = container.querySelector("div");
      expect(div?.className).toContain("prose");
    });
  ...
  describe("Markdown Parsing", () => {
    ...
    it("should render links", () => {
      const { container } = render(
        <MarkdownRenderer content="[Link text](https://example.com)" />,
      );
...
| Cell 1   | Cell 2   |`;
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle special characters", () => {
      const { container } = render(
        <MarkdownRenderer content={"Special: <>&\"'"} />,
      );
