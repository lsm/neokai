...
import { navigateToSession, navigateToSettings } from '../lib/router.ts';
			...
			<div class={`bg-dark-850/50 backdrop-blur-sm border-b ${borderColors.ui.default} p-4`}>
				<div class="max-w-6xl mx-auto w-full px-4 md:px-6 flex items-center gap-3">
					...
					<button
						...
						class={`p-2 bg-dark-850 border ${borderColors.ui.default} rounded-lg hover:bg-dark-800 transition-colors text-gray-400 hover:text-gray-100 flex-shrink-0`}
