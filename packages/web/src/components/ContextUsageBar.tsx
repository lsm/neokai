...
export default function ContextUsageBar({
  ...
  const getCategoryColor = (
    ...
    if (
      normalizedCategory.includes("output tokens") ||
      normalizedCategory.includes("output")
    ) {
      return {
        bg: "bg-green-500",
        text: "text-green-400",
  ...
  return (
    <>
      ...
      <div
        ...
        onClick={() =>
          totalTokens > 0 && setShowContextDetails(!showContextDetails)
        }
        title={
          totalTokens > 0
                ...
                <div class="space-y-3">
                  ...
                  <div class="bg-dark-700 rounded-lg p-2.5">
                    <div class="flex justify-between items-center mb-1.5">
                      ...
                      <span
                        class={`text-xs font-semibold ${getContextColor()}`}
                      >
                        {contextPercentage.toFixed(1)}%
                      </span>
                    </div>
                    ...
                    <div class="text-xs text-gray-500 mt-1">
                      ...
                      {contextCapacity.toLocaleString()}
                    </div>
                  </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <div class="space-y-1.5">
                        {Object.entries(contextUsage.breakdown)
                          .sort(
                            ([categoryA], [categoryB]) =>
                              getCategorySortOrder(categoryA) -
                              getCategorySortOrder(categoryB),
                          )
                          .map(([category, data]) => {
                            ...
                            return (
                              ...
                              >
                                {/* Colored square icon */}
                                <div
                                  class={`w-3 h-3 rounded ${bg} flex-shrink-0`}
                                />
