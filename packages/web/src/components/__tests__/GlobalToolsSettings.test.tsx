...
describe("GlobalToolsSettings Logic", () => {
  ...
  describe("Loading State", () => {
    ...
    it("should support async config loading", async () => {
      const loadConfig = vi.fn(() =>
        Promise.resolve({ config: DEFAULT_CONFIG }),
      );
  ...
  describe("System Prompt Settings", () => {
    ...
    it("should have Claude Code preset enabled by default", () => {
      expect(
        DEFAULT_CONFIG.systemPrompt?.claudeCodePreset?.defaultEnabled,
      ).toBe(true);
    });
  ...
  describe("Save Functionality", () => {
    ...
    it("should handle save failure", async () => {
      ...
      expect(toastFn).toHaveBeenCalledWith(
        "Failed to save global tools settings",
      );
    });
  });
  ...
  describe("Config Defaults", () => {
    it("should use default values for missing config fields", () => {
      ...
      const allowed =
        partialConfig.systemPrompt?.claudeCodePreset?.allowed ?? true;
      const defaultEnabled =
        partialConfig.systemPrompt?.claudeCodePreset?.defaultEnabled ?? true;
