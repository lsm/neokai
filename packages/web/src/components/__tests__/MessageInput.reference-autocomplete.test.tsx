...
describe('MessageInput reference autocomplete', () => {
	...
	describe('textarea height padding sync', () => {
		...
		it('does not sync messages bottom padding from textarea growth on iOS Safari while keyboard is open', () => {
			Object.defineProperty(navigator, 'userAgent', {
				configurable: true,
				value:
		...
		it('continues syncing messages bottom padding on non-iOS mobile browsers', () => {
			Object.defineProperty(navigator, 'userAgent', {
				configurable: true,
				value:
		...
		it('re-syncs messages bottom padding when the iOS Safari keyboard closes', () => {
			Object.defineProperty(navigator, 'userAgent', {
				configurable: true,
				value:
					'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 Version/17.0 Mobile/15E148 Safari/604.1',
