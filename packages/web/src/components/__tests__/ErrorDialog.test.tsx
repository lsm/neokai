...
describe("ErrorDialog", () => {
  ...
  describe("Error Object Structure", () => {
    ...
    it("should have user message", () => {
      expect(mockError.userMessage).toBe(
    ...
    it("should have recovery suggestions", () => {
      ...
      expect(mockError.recoverySuggestions?.[0]).toBe(
        "Check that your API key is valid",
      );
    });
    ...
    it("should have session context", () => {
      ...
      expect(mockError.sessionContext?.processingState?.status).toBe(
        "processing",
      );
    });
  ...
  describe("Processing State in Error", () => {
    ...
    it("should include message ID when available", () => {
      expect(mockError.sessionContext?.processingState?.messageId).toBe(
        "msg-456",
      );
    });
  });
