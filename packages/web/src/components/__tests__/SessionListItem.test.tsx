...
describe("SessionListItem", () => {
  ...
  describe("Worktree Badge", () => {
    ...
    it("should have correct title on worktree icon", () => {
      ...
      const worktreeSpan = container.querySelector(
        '[title="Worktree: session/test-branch"]',
      );
  ...
  describe("Archived Status", () => {
    ...
    it("should have correct title on archived icon", () => {
      ...
      const archivedSpan = container.querySelector(
  ...
  describe("Metadata Display", () => {
    ...
    it("should handle large token counts", () => {
      ...
      const { container } = render(
        <SessionListItem
          session={sessionWithLargeTokens}
          onSessionClick={mockOnSessionClick}
        />,
      );
