	...
	describe('Different Media Types', () => {
		it('should handle PNG images', () => {
			const pngAttachment: AttachmentWithMeta = {
				type: 'image',
				source: { type: 'base64', media_type: 'image/png', data: minimalPngBase64 },
				media_type: 'image/png',
				data: minimalPngBase64,
				name: 'image.png',
				size: 1000,
		...
		it('should handle JPEG images', () => {
			const jpegAttachment: AttachmentWithMeta = {
				type: 'image',
				source: { type: 'base64', media_type: 'image/jpeg', data: minimalPngBase64 },
				media_type: 'image/jpeg',
				data: minimalPngBase64,
				name: 'photo.jpg',
				size: 1000,
		...
		it('should handle GIF images', () => {
			const gifAttachment: AttachmentWithMeta = {
				type: 'image',
				source: { type: 'base64', media_type: 'image/gif', data: minimalPngBase64 },
				media_type: 'image/gif',
				data: minimalPngBase64,
				name: 'animation.gif',
				size: 1000,
		...
		it('should handle WebP images', () => {
			const webpAttachment: AttachmentWithMeta = {
				type: 'image',
				source: { type: 'base64', media_type: 'image/webp', data: minimalPngBase64 },
