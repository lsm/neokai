...
describe("InputActionsMenu", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should not render menu when closed", () => {
      const { container } = render(
        <InputActionsMenu {...defaultProps} isOpen={false} />,
      );
    ...
    it("should render menu when open", () => {
      const { container } = render(
        <InputActionsMenu {...defaultProps} isOpen={true} />,
      );
  ...
  describe("Disabled State", () => {
    it("should disable button when disabled prop is true", () => {
      const { container } = render(
        <InputActionsMenu {...defaultProps} disabled={true} />,
      );
      const button = container.querySelector("button");
  ...
  describe("Tools Button", () => {
    it("should call onOpenTools and close menu on click", () => {
      ...
      const buttons = container.querySelectorAll("button");
      const toolsButton = Array.from(buttons).find((b) =>
  ...
  describe("Attach File Button", () => {
    it("should call onAttachFile and close menu on click", () => {
      ...
      const buttons = container.querySelectorAll("button");
      const attachButton = Array.from(buttons).find((b) =>
        b.textContent?.includes("Attach"),
      );
      attachButton?.click();
