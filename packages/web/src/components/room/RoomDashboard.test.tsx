...
describe('RoomDashboard', () => {
	...
	describe('Stats Overview', () => {
		...
		it('should show pending tasks count', () => {
			mockTasks.value = [createTask('t1', 'pending'), createTask('t2', 'pending')];
		...
		it('should show failed tasks count', () => {
			mockTasks.value = [createTask('t1', 'failed')];
		...
		it('should show 5-column stat grid', () => {
			const { container } = render(<RoomDashboard />);
		...
		it('should show correct counts for mixed task statuses', () => {
			mockTasks.value = [
				createTask('t1', 'pending'),
				createTask('t2', 'in_progress'),
				createTask('t3', 'completed'),
				createTask('t4', 'failed'),
				createTask('t5', 'pending'),
			];
			mockSessions.value = [{ id: 's1', title: 'Session', status: 'active' }];
			...
			// Order: Sessions, Pending, Active, Completed, Failed
			expect(values).toEqual(['1', '2', '1', '1', '1']);
		});
	});
