/**
 * SettingsIcon - Icon component for settings sections
 *
 * Simple SVG icons for settings navigation.
 */

import type { SettingsIcon as SettingsIconType } from '../../../lib/constants/settings-sections.ts';

export interface SettingsIconProps {
	name: SettingsIconType;
	class?: string;
}

export function SettingsIcon({ name, class: className = '' }: SettingsIconProps) {
	const icons: Record<SettingsIconType, string> = {
	...
	const svgContent = icons[name] || icons.cog;
