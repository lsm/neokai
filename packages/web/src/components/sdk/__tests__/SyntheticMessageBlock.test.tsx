...
describe("SyntheticMessageBlock", () => {
  describe("Basic Rendering", () => {
    ...
    it("should include timestamp in data attribute", () => {
      ...
      expect(element?.getAttribute("data-message-timestamp")).toBe(
        String(timestamp),
      );
    });
  });
  ...
  describe("Synthetic Badge", () => {
    ...
    it("should have purple styling for synthetic badge", () => {
      ...
      expect(
        container.querySelector(".bg-purple-500\\/20, .text-purple-300"),
      ).toBeTruthy();
    });
  });
  ...
  describe("Styling", () => {
    ...
    it("should have purple border and background", () => {
      ...
      expect(
        container.querySelector(".bg-purple-900\\/20, .border-purple-700\\/50"),
      ).toBeTruthy();
    });
  ...
  describe("Edge Cases", () => {
    it("should handle empty content array", () => {
      const { container } = render(
        <SyntheticMessageBlock content={[]} timestamp={Date.now()} />,
      );
