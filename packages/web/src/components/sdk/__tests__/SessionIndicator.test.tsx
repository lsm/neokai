...
describe("SessionIndicator", () => {
  describe("Header", () => {
    it('should render "Session Started" header', () => {
      ...
      const { container } = render(
        <SessionIndicator sessionInfo={sessionInfo} />,
      );
  ...
  describe("Styling", () => {
    it("should have indigo color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-indigo-50, .dark\\:bg-indigo-900\\/70"),
      ).toBeTruthy();
    });
  ...
  describe("Edge Cases", () => {
    it("should handle long working directory paths", () => {
      const longPath =
        "/very/long/path/that/goes/on/and/on/to/test/overflow/handling/properly";
