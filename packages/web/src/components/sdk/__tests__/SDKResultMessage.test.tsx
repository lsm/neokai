...
function createResultWithPermissionDenials(): Extract<
  SDKMessage,
  { type: "result" }
> {
  return {
...
function createResultWithStructuredOutput(): Extract<
  SDKMessage,
  { type: "result" }
> {
  return {
...
describe("SDKResultMessage", () => {
  describe("Compact Summary (Collapsed State)", () => {
    ...
    it("should show success icon for successful result", () => {
      ...
      const svg = container.querySelector(
        "svg.text-green-600, svg.text-green-400",
      );
  ...
  describe("Error Results", () => {
    ...
    it("should have error styling", () => {
      ...
      expect(
        container.querySelector(".bg-red-50, .dark\\:bg-red-900\\/10"),
      ).toBeTruthy();
    });
  });
  ...
  describe("Styling", () => {
    it("should have success styling for successful result", () => {
      ...
      expect(
        container.querySelector(".bg-green-50, .dark\\:bg-green-900\\/10"),
      ).toBeTruthy();
    });
