...
describe("SubagentBlock", () => {
  describe("Basic Rendering", () => {
    it("should render subagent type badge", () => {
      ...
      const { container } = render(
        <SubagentBlock input={input} toolId="toolu_task123" />,
      );
  ...
  describe("Subagent Types", () => {
    it("should render Explore type with cyan color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-cyan-50, .dark\\:bg-cyan-900\\/20"),
      ).toBeTruthy();
    });
    ...
    it("should render Plan type with violet color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-violet-50, .dark\\:bg-violet-900\\/20"),
      ).toBeTruthy();
    });
    ...
    it("should render claude-code-guide type with amber color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-amber-50, .dark\\:bg-amber-900\\/20"),
      ).toBeTruthy();
    });
    ...
    it("should render general-purpose type with indigo color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-indigo-50, .dark\\:bg-indigo-900\\/20"),
      ).toBeTruthy();
    });
  ...
  describe("Nested Messages", () => {
    it("should show nested messages section when messages are provided", () => {
      ...
      const nestedMessages = [
        createNestedAssistantMessage("I found the files."),
      ];
    ...
    it("should render nested assistant messages", () => {
      ...
      const nestedMessages = [
        createNestedAssistantMessage("I found 3 test files."),
      ];
    ...
    it("should render nested user messages", () => {
      ...
      const nestedMessages = [
        createNestedUserMessage("Check in the src folder."),
      ];
    ...
    it("should render nested tool use blocks", () => {
      ...
      const toolResultsMap = new Map([
        ["toolu_nested123", { content: "File content here" }],
      ]);
  ...
  describe("Error State", () => {
    ...
    it("should apply error styling to output text", () => {
      ...
      expect(
        container.querySelector(".text-red-600, .text-red-400"),
      ).toBeTruthy();
    });
  });
  ...
  describe("Chevron Rotation", () => {
    it("should rotate chevron when expanded", () => {
      ...
      expect(
        rotatedChevron?.className.baseVal ||
          rotatedChevron?.getAttribute("class"),
