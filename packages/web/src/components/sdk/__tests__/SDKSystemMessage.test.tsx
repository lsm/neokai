...
function createHookResponseWithError(): Extract<
  SDKMessage,
  { type: "system" }
> {
  return {
...
describe("SDKSystemMessage", () => {
  ...
  describe("Compact Boundary Message", () => {
    ...
    it("should show trigger type (Auto/Manual)", () => {
      ...
      const { container: autoContainer } = render(
        <SDKSystemMessage message={autoMessage} />,
      );
      ...
      const { container: manualContainer } = render(
        <SDKSystemMessage message={manualMessage} />,
      );
  ...
  describe("Status Message", () => {
    ...
    it("should have yellow color scheme for compacting", () => {
      ...
      expect(
        container.querySelector(".text-yellow-600, .text-yellow-400"),
      ).toBeTruthy();
    });
  });
  ...
  describe("Hook Response Message", () => {
    ...
    it("should have purple color scheme", () => {
      ...
      expect(
        container.querySelector(".bg-purple-50, .dark\\:bg-purple-900\\/20"),
      ).toBeTruthy();
    });
  });
  ...
  describe("Chevron Rotation", () => {
    it("should rotate chevron when expanded", () => {
      ...
      expect(
        rotatedSvg?.className.baseVal || rotatedSvg?.getAttribute("class"),
