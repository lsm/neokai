...
export function DiffViewer({
  ...
  return (
    <div class={cn('rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700', className)}>
      {/* Header */}
      {filePath && (
              ...
              if (line.type === 'separator') {
                return (
                  <tr key={idx} class="bg-gray-100 dark:bg-gray-800">
                    <td class="px-2 py-1 text-center text-gray-500 dark:text-gray-400 select-none" colSpan={3}>
                      {line.content}
                    </td>
                  </tr>
                );
