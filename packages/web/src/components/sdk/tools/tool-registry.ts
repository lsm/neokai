...
const defaultToolConfigs: Record<string, ToolConfig> = {
  ...
  NotebookEdit: {
    ...
    summaryExtractor: (input) =>
      extractFileName(getProp(input, "notebook_path")),
    hasLongOutput: false,
    defaultExpanded: false,
  },
  ...
  BashOutput: {
    ...
    category: "terminal",
    summaryExtractor: (input) =>
      `Shell: ${getProp(input, "bash_id")?.slice(0, 8) || "unknown"}`,
    hasLongOutput: true,
    defaultExpanded: false,
  },
  KillShell: {
    ...
    category: "terminal",
    summaryExtractor: (input) =>
      `Shell: ${getProp(input, "shell_id")?.slice(0, 8) || "unknown"}`,
    hasLongOutput: false,
    defaultExpanded: false,
  },
  ...
  Task: {
    ...
    category: "agent",
    summaryExtractor: (input) =>
      getProp(input, "description") || "Task execution",
    hasLongOutput: true,
    defaultExpanded: false,
  },
  Agent: {
    ...
    category: "agent",
    summaryExtractor: (input) =>
      getProp(input, "description") || "Agent execution",
    hasLongOutput: true,
    defaultExpanded: false,
  },
  ...
  TimeMachine: {
    ...
    category: "system",
    summaryExtractor: (input) =>
      truncateString(getProp(input, "message_prefix"), 40),
    hasLongOutput: false,
    defaultExpanded: false,
  },
  Thinking: {
