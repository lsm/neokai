...
describe("ToolProgressCard", () => {
  ...
  describe("Elapsed Time Formatting", () => {
    it("should format milliseconds for times less than 1 second", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} elapsedTime={0.5} />,
      );
    ...
    it("should format seconds for times less than 60 seconds", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} elapsedTime={30.5} />,
      );
    ...
    it("should format minutes and seconds for times over 60 seconds", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} elapsedTime={90} />,
      );
    ...
    it("should handle zero elapsed time", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} elapsedTime={0} />,
      );
  ...
  describe("Default Variant", () => {
    ...
    it("should show parent tool ID when provided", () => {
      const { container } = render(
        <ToolProgressCard
          {...defaultProps}
          parentToolUseId="parent-tool-abc"
        />,
      );
  ...
  describe("Compact Variant", () => {
    it("should render in compact style", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} variant="compact" />,
      );
  ...
  describe("Inline Variant", () => {
    it("should render as inline element", () => {
      const { container } = render(
        <ToolProgressCard {...defaultProps} variant="inline" />,
      );
