...
describe("TodoViewer", () => {
  ...
  describe("Status Badges", () => {
    ...
    it("should show Pending badge for pending todos", () => {
      const { container } = render(
        <TodoViewer
          todos={[
            { content: "Waiting task", status: "pending", activeForm: "" },
          ]}
        />,
      );
  ...
  describe("Status Icons", () => {
    it("should show checkmark icon for completed todos", () => {
      const { container } = render(
        <TodoViewer
          todos={[{ content: "Done", status: "completed", activeForm: "" }]}
        />,
      );
    ...
    it("should show spinner icon for in_progress todos", () => {
      const { container } = render(
        <TodoViewer
          todos={[
            { content: "Working", status: "in_progress", activeForm: "" },
          ]}
        />,
      );
    ...
    it("should show clock icon for pending todos", () => {
      const { container } = render(
        <TodoViewer
          todos={[{ content: "Waiting", status: "pending", activeForm: "" }]}
        />,
      );
          ...
          todos={[
            {
              content: "Done task",
              status: "completed",
              activeForm: "This should not show",
            },
          ]}
        />,
      );
  ...
  describe("Visual Styling", () => {
    ...
    it("should have white background for pending todos", () => {
      const { container } = render(
        <TodoViewer
          todos={[{ content: "Pending", status: "pending", activeForm: "" }]}
        />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle long todo content", () => {
      ...
      const todos = [
        { content: longContent, status: "pending" as const, activeForm: "" },
      ];
      const { container } = render(<TodoViewer todos={todos} />);
