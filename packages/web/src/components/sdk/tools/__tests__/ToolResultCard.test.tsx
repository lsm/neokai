...
const TOOL_COLORS = {
	...
	search: { bg: 'bg-purple-50', border: 'border-purple-200', text: 'text-purple-600' },
	command: { bg: 'bg-green-50', border: 'border-green-200', text: 'text-green-600' },
	thinking: { bg: 'bg-amber-50', border: 'border-amber-200', text: 'text-amber-600' },
	system: { bg: 'bg-gray-50', border: 'border-gray-200', text: 'text-gray-600' },
};
...
describe('ToolResultCard Logic', () => {
	...
	describe('Input Summary Formatting', () => {
		it('should format Read tool input', () => {
			const summary = formatInputSummary('Read', { file_path: '/path/to/file.ts' });
	...
	describe('Special Tool Rendering Logic', () => {
		describe('Edit Tool', () => {
			it('should detect Edit tool with diff data', () => {
				...
				const hasDiff =
					toolName === 'Edit' && input.old_string !== undefined && input.new_string !== undefined;
		...
		describe('Write Tool', () => {
			it('should detect Write tool with content', () => {
				...
				const hasWriteContent = toolName === 'Write' && input.content !== undefined;
