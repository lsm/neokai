...
export function ToolProgressCard({
  ...
  if (variant === 'compact') {
    return (
      <div class={cn('flex items-center gap-2 py-1 px-2 rounded', colors.bg, colors.border, 'border', className)}>
  ...
  return (
    <div class={cn('py-2 px-3 rounded-lg border flex items-center gap-3', colors.bg, colors.border, className)}>
      ...
      <div class="flex-shrink-0">
        <div class="flex gap-1">
          <div class={cn('w-1.5 h-1.5 rounded-full animate-pulse', colors.iconColor)} style="animation-delay: 0ms" />
          <div class={cn('w-1.5 h-1.5 rounded-full animate-pulse', colors.iconColor)} style="animation-delay: 150ms" />
          <div class={cn('w-1.5 h-1.5 rounded-full animate-pulse', colors.iconColor)} style="animation-delay: 300ms" />
        </div>
      </div>
    </div>
  );
