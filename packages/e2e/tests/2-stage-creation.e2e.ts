...
test.describe("2-Stage Session Creation", () => {
  ...
  test("should show default title initially (New Session)", async ({
    page,
  }) => {
    // Create a new session
    const newSessionButton = page.getByRole("button", {
  ...
  test("should generate title after first message (Stage 2)", async ({
    page,
  }) => {
    // Create a new session
    const newSessionButton = page.getByRole("button", {
  ...
  test("should show session in sidebar immediately after creation", async ({
    page,
  }) => {
    // Create a new session
    const newSessionButton = page.getByRole("button", {
