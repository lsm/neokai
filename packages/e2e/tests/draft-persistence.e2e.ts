...
test.describe("Draft Persistence", () => {
  ...
  test.skip("should not restore sent message as draft after page reload", async ({
    page,
  }) => {
  ...
  test("should clear draft when user manually deletes all text", async ({
    page,
  }) => {
    // Create new session
    await page
  ...
  test("should handle rapid typing and sending without draft interference", async ({
    page,
  }) => {
    // Create new session
    await page
  ...
  test.skip("should preserve draft when switching sessions without sending", async ({
    page,
  }) => {
    // TODO: Draft persistence feature may not be fully implemented
