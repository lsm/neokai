...
test.describe("Draft Clearing Bug Fix", () => {
  ...
  test("should NOT restore sent message as draft after session switch", async ({
    page,
  }) => {
    ...
    const firstSessionId =
      await firstSessionButton.getAttribute("data-session-id");
    ...
    const secondSessionId =
      await secondSessionButton.getAttribute("data-session-id");
  ...
  test("should NOT restore sent message as draft after page reload", async ({
    page,
  }) => {
    // Create new session
    await page
  ...
  test("should handle rapid send without draft race condition", async ({
    page,
  }) => {
    // Create new session
    await page
