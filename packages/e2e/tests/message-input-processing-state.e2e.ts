...
test.describe("Message Input Processing State", () => {
  ...
  test.skip("should keep plus button enabled during processing", async ({
    page,
  }) => {
    // Create a session
    await page
    ...
    const menu = page
      .locator('div:has(> button:has-text("Auto-scroll"))')
      .first();
  ...
  test.skip("should disable model switcher during processing", async ({
    page,
  }) => {
    // Create a session
    await page
  ...
  test("should allow typing in textarea during processing", async ({
    page,
  }) => {
    // Create a session
    await page
  ...
  test.skip("should show visual feedback when model switcher is disabled during processing", async ({
    ...
    const modelSwitcherBefore = page
      ...
      .first();
    const classesBeforeProcessing =
      await modelSwitcherBefore.getAttribute("class");
    ...
    const modelSwitcherDuringProcessing = page
      ...
      .first();
    const classesDuringProcessing =
      await modelSwitcherDuringProcessing.getAttribute("class");
