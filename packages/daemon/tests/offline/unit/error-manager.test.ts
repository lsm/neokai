...
describe("ErrorManager", () => {
  ...
  describe("rich error context", () => {
    ...
    it("should include session context when provided", () => {
      ...
      expect(structured.sessionContext?.processingState?.status).toBe(
        "processing",
      );
      expect(structured.sessionContext?.processingState?.phase).toBe(
        "thinking",
      );
    });
    ...
    it("should provide different suggestions based on error code", () => {
      ...
      expect(quotaError.recoverySuggestions).toContain(
  ...
  describe("handleError with rich context", () => {
    ...
    it("should emit error via EventBus", async () => {
      ...
      expect(emittedData.details.sessionContext?.processingState).toEqual(
        processingState,
      );
