...
export class SubscriptionManager {
  ...
  async subscribeToGlobalEvents(clientId: string): Promise<void> {
    ...
    console.log(`[SubscriptionManager] Client ${clientId} subscribed to ${globalEvents.length} global events`);
  }
  ...
  async subscribeToSessionEvents(
    ...
    console.log(`[SubscriptionManager] Subscribing client ${clientId} to session ${sessionId} events`);
