...
export function registerSettingsHandlers(
	 ...
	 * Get global settings
	 */
	messageHub.onQuery('settings.global.get', async () => {
	 ...
	 */
	messageHub.onQuery('settings.global.save', async (data: { settings: GlobalSettings }) => {
	 ...
	 */
	messageHub.onQuery('settings.mcp.getDisabled', async () => {
		return {
	 ...
	 */
	messageHub.onQuery('settings.mcp.setDisabled', async (data: { disabledServers: string[] }) => {
	 ...
	 */
	messageHub.onQuery('settings.fileOnly.read', async () => {
	 ...
	 */
	messageHub.onQuery('settings.mcp.listFromSources', async (data?: { sessionId?: string }) => {
	 ...
	 */
	messageHub.onQuery('settings.session.get', async (data: { sessionId: string }) => {
