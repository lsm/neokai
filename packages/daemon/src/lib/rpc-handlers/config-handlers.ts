...
export function setupConfigHandlers(
  ...
  messageHub.handle("config.model.get", async (data) => {
  ...
  messageHub.handle("config.model.update", async (data) => {
    ...
    if (settings.maxThinkingTokens !== undefined) {
      const result = await agentSession.setMaxThinkingTokens(
  ...
  messageHub.handle("config.systemPrompt.get", async (data) => {
  ...
  messageHub.handle("config.systemPrompt.update", async (data) => {
    const { sessionId, systemPrompt, restartQuery } =
      data as UpdateSystemPromptRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.tools.get", async (data) => {
  ...
  messageHub.handle("config.tools.update", async (data) => {
    const { sessionId, settings, restartQuery } =
      data as UpdateToolsConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
    ...
    if (settings.tools !== undefined)
      configUpdate.sdkToolsPreset = settings.tools;
    if (settings.allowedTools !== undefined)
      configUpdate.allowedTools = settings.allowedTools;
  ...
  messageHub.handle("config.agents.get", async (data) => {
  ...
  messageHub.handle("config.agents.update", async (data) => {
    const { sessionId, agents, restartQuery } =
      data as UpdateAgentsConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.sandbox.get", async (data) => {
  ...
  messageHub.handle("config.sandbox.update", async (data) => {
    const { sessionId, sandbox, restartQuery } =
      data as UpdateSandboxConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.mcp.get", async (data) => {
  ...
  messageHub.handle("config.mcp.update", async (data) => {
    const { sessionId, mcpServers, strictMcpConfig, restartQuery } =
      data as UpdateMcpConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
    ...
    if (strictMcpConfig !== undefined)
      configUpdate.strictMcpConfig = strictMcpConfig;
  ...
  messageHub.handle("config.mcp.addServer", async (data) => {
    const { sessionId, name, config, restartQuery } =
      data as AddMcpServerRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.mcp.removeServer", async (data) => {
  ...
  messageHub.handle("config.outputFormat.get", async (data) => {
  ...
  messageHub.handle("config.outputFormat.update", async (data) => {
    const { sessionId, outputFormat, restartQuery } =
      data as UpdateOutputFormatRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.betas.get", async (data) => {
  ...
  messageHub.handle("config.betas.update", async (data) => {
  ...
  messageHub.handle("config.env.get", async (data) => {
  ...
  messageHub.handle("config.env.update", async (data) => {
    const { sessionId, settings, restartQuery } =
      data as UpdateEnvConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.permissions.get", async (data) => {
  ...
  messageHub.handle("config.permissions.update", async (data) => {
    const { sessionId, permissionMode } =
      data as UpdatePermissionsConfigRequest;
    const agentSession = await sessionManager.getSessionAsync(sessionId);
    if (!agentSession) throw new Error("Session not found");
  ...
  messageHub.handle("config.getAll", async (data) => {
  ...
  messageHub.handle("config.updateBulk", async (data) => {
    ...
    if (runtimeConfig.permissionMode) {
      const result = await agentSession.setPermissionMode(
    ...
    if (remainingKeys.length > 0) {
      ...
      if ("tools" in configToUpdate && configToUpdate.tools !== undefined) {
        (configToUpdate as Record<string, unknown>).sdkToolsPreset =
          configToUpdate.tools;
        delete (configToUpdate as Record<string, unknown>).tools;
      }

      await agentSession.updateConfig(
        configToUpdate as Partial<Session["config"]>,
      );
