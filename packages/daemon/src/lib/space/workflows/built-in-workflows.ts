			...
			agents: [
				{
					...
					customPrompt: {
						value:
							...
							'Post all feedback as PR review comments on GitHub via `gh pr review` / `gh api` ' +
							'so the engineer can address them item by item; then send a short message to ' +
							'Coding summarizing the request.\n\n' +
