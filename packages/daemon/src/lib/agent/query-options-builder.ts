...
export class QueryOptionsBuilder {
  ...
  async build(): Promise<Options> {
    ...
    const sdkModelId = providerService.translateModelIdForSdk(
    ...
    this.logger.log(`Query options:`, {
      ...
      allowDangerouslySkipPermissions:
        cleanedOptions.allowDangerouslySkipPermissions,
      useClaudeCodePreset,
      ...
      agents: cleanedOptions.agents
        ? Object.keys(cleanedOptions.agents)
        : undefined,
  ...
  addSessionStateOptions(options: Options): Options {
    ...
    const thinkingLevel = (this.session.config.thinkingLevel ||
